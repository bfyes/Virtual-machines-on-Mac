...
更新时间：2026-03-28，更新说明：**新增章节：打包虚拟机映像**
...
另：汇编语言课程的 UTM 虚拟机文件我已经打包好，如果需要，可以联系我拷贝。为了保护老师的成果和隐私，这个网页中暂不提供下载链接。
...
1. 安装 7-Zip 工具（若未安装）
    在终端（terminal）中输入：`brew install p7zip`。
    > 还有类似的包，欢迎自行探索！
    
!!!warning
    压缩前请关闭虚拟机，防止磁盘映像损坏。

2. 指令示例：`7za a test.zip ～/Parallels/Windows\ XP.utm`（.utm并非后缀，而是文件夹名称的一部分）。
