...
更新时间：2026-03-27，更新说明：**刚才发现Xftp5可以调用XShell5，能直接访问终端。看来这个xp系统里有很多宝贝等待探索！**

更新时间：2026-03-26，更新说明：**完善文章框架和步骤。**

这篇文章技术含量并不高，只是略微折腾。现在想来，安装过程和原理都算不上麻烦，但当初前前后后摸索了近两周。所以把方法总结出来，方便有需要的同学复现。

- 写作工具：Typora；环境：macOS 26.3.1；网页构建工具：Mkdocs。

> 文章偏记录向，如有不当之处，请多指教！

另：汇编语言课程的 UTM 虚拟机文件我已经打包好，如果实在需要，请联系我拷贝。为了保护老师的成果和隐私，这个网页中暂不提供下载链接。
...
#### 完成验证：得到可被 UTM 直接导入的 .qcow2 磁盘文件，大小应与vmdk文件类似。
...
5. Windows XP 硬件配置：
    ...
    - 下面给出了笔者安装时的资源（可以用迅雷等打开。⚠️注意：非官方资源，请自行甄别。可以寻找官方资源。）
